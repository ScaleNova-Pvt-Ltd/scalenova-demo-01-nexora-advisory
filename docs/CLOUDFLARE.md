# Cloudflare Workers Deployment Guide — Nexora Advisory

## 1. Overview
Nexora Advisory (`DEMO-01`) is engineered for sub-second global edge delivery via **Cloudflare Workers** with Static Assets.

- **Primary Custom Domain**: `https://demo1.scalenovasys.com`
- **Fallback URL**: `https://scalenova-demo-01-nexora-advisory.<account>.workers.dev`
...
3. Select **Connect to Git** and choose the repository:
   `ScaleNova-Pvt-Ltd/scalenova-demo-01-nexora-advisory`
...
2. Add custom domain: `demo1.scalenovasys.com`.
