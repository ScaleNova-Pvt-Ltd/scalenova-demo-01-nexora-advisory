# Google Sheets Intake Architecture — Nexora Advisory
...
- **Assigned Worksheet**: `Demo 1 - Professional`

## 2. Standard 23-Column Schema
Each row in `Demo 1 - Professional` is stored with 23 standardized columns:

1. **Submission ID**: Unique deterministic key (e.g. `SN-NEX-202609-1234`)
2. **Created At**: ISO-8601 UTC timestamp
3. **Demo ID**: `DEMO-01`
4. **Industry**: `Professional & B2B Services`
5. **Client Name**: `Nexora Advisory`
...
17. **Source**: `Nexora Advisory Website`
