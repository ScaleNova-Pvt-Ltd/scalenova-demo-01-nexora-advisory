...
| `demoId` | Demo ID | `custom_demo_id` | Data | e.g. `DEMO-01` |
| `submissionId` | Submission ID | `custom_submission_id` | Data | e.g. `SN-NEX-202609-1234` |
| `source` | Source | `source` | Select | "ScaleNova Demo — Professional & B2B Services" |
